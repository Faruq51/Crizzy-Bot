...
switch(command){
			...
			case'help': {
				...
				anu = `${fke}Hi ${m.pushName} 👋, i'am Z E R O - T W O!${fke}
...
Konfirmasi pembayaran mu dengan menunjjukan bukti transfer kepada owner!
			...
			case 'tk': case 'tarikkomisi': {
				...
				let nyobb = list
				conn.sendMessage(from, {text:`*PILLIH E-WALLET*\nPilih jenis wallet yang ingin anda gunakan!`, title: 'WALLET', footer: '© 2022 Farquofc', buttons: nyobb})
				}
				break
