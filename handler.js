...
return buffer
	...
	const fgclink = {key: {participant: "0@s.whatsapp.net","remoteJid": "0@s.whatsapp.net"},"message": {"groupInviteMessage": {"groupJid": "6283102650464-1589321480@g.us","inviteCode": "m","groupName": "Crizzy Bot", "caption": `© Faruqofc`, 'jpegThumbnail': global.thumb}}}
    const fvideo = {key: { fromMe: false,participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "6283102650464-1589321480@g.us" } : {}) },message: { "videoMessage": { "title":`*AUTO DOWNLOAD AUDIO YOUTUBE*`, "h": `Hmm`,'seconds': '10000000⁰0', 'caption': `*AUTO DOWNLOAD AUDIO YOUTUBE*`, 'jpegThumbnail': global.thumb}}}
		...
		const buttonsDefault = [
			//{ callButton: { displayText: `Call Owner!`, phoneNumber: `+6285807264974` } },
...
switch(command){
			...
			case'help': {
				...
				anu = `${fke}Hi ${m.pushName} 👋, Hi Kak I,m Z E R O - T W O${fke}
...
Konfirmasi pembayaran mu dengan menunjjukan bukti transfer kepada owner!
				 ...
				 but = [
                    {buttonId: `qris`, buttonText: {displayText: 'Pay With QRIS'}, type: 1},
                    {buttonId: `owner`, buttonText: {displayText: 'Confirm to owner'}, type: 2} 
                ]
					conn.sendMessage(from, { caption: pes, image: { url: 'https://telegra.ph/file/2c5fd28606430a11da06a.png' } , buttons: but, footer: `Thank you for your help and support to this bot, hopefully the sustenance will be smoother. \n For more information, please contact the owner!\n\n© 2022 Faruqofc` })
					} 
				break
			case 'qriscrizzy':{
				...
				bta = [
						...
						conn.sendMessage(from, { caption: captionQris, image: { url: 'https://telegra.ph/file/2c5fd28606430a11da06a.png' } , buttons: bta, footer: `Thank you for your help and support to this bot, hopefully the sustenance will be smoother. \n\n© 2022 Faruqofc` })
						} 
			...
			case 'tk': case 'tarikkomisi': {
				...
				let nyobb = list
				conn.sendMessage(from, {text:`*PILLIH E-WALLET*\nPilih jenis wallet yang ingin anda gunakan!`, title: 'WALLET', footer: '© 2022 Faruqofc', buttons: nyobb})
				}
				break
...
break*/
			...
			let buttons = [
                ...
                conn.sendMessage(from, {text:`*NGETES BUTTON*`, title: 'WALLET', footer: '© 2022 Faruqofc', buttons: buttons})
                }
                break
...
if ((m.mtype === 'reactionMessage') && m.isGroup) {
    conn.sendMessage(from, {text: `Terdeteksi *${m.pushName} @${m.sender.split("@")[0]}* Mengirim Reaction.`, mentions: [m.sender]}, {quoted: fake})
        ...
        if ((m.mtype === 'groupInviteMessage' || budy.startsWith('https://chat') || budy.startsWith('Buka tautan ini')) && !m.isBaileys && !m.isGroup) {
			...
			conn.sendMessage(from, {text:`INVITE DETECT\n\nMau masukin bot ini ke group kamu?`, title: 'LINK GROUP DECTETED', footer: '© 2022 Faruqofc', buttons: buttons, headerType: 5})
		}
